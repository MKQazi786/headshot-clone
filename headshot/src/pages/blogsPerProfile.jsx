    ...
    return (
        <>
            ...
            <main className="mainDiv" >
                ...
                <h3 className="iCF" >Insufficient Cash Flow</h3>
                <p>
                ...
                <h3>insufficient number of profitable sales</h3>
                <p>
                    ...
                    <br /><br />
                    For this you’ll need a construction Customer Relationship Management (CRM) software solution. For obvious reasons, I recommend <i> Projul.</i> But in all honesty, it’s really the <i>Best construction CRM </i> and construction management system on the market for construction and specialty contractor businesses that want to make success easy.
                </p>

                <h3>lack of change orders</h3>
                <p>
                ...
                <h3>excess overhhead and employees</h3>
                <p>
                ...
                <h3>Lack of Organization, Processes & Decision Making Data</h3>
                <p>
                ...
                <p>
                    ...
                    <br /><br />
                    There are a few decent construction management software products on the market that will make your construction life easier and more productive. <i>If you’re operating a small to mid-size construction company of 4 to 50 employees then of course I highly recommend Projul </i> construction management software.
                    <br /><br />
                ...
                <div className="divRB" >
                    ...
                    <p className="paraRB">Recent Blogs</p>
                    <p>
                        Create professional portraits of the highest caliber for every need, from
                        a simple business headshot, content marketing and even offline collateral.
                    </p>
                </div>
